...
class DialogProducto(QDialog):
    ...
    def _setup_ui(self):
        ...
        def mk_label(text):
            lbl = QLabel(text)
            lbl.setFont(QFont("Arial", 11, QFont.DemiBold))
        ...
        self.f_codigo.setFixedHeight(42)
        ...
        self.f_nombre.setFixedHeight(42)
        ...
        self.f_precio.setFixedHeight(42)
        ...
        self.f_stock.setFixedHeight(42)
        if self._producto:
        ...
        self.f_stock_min.setFixedHeight(42)
